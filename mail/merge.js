module.exports = {
  ...
  <div class="container" style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ccc; border-radius: 5px;">
    ...
    <p style=" margin-bottom: 10px;">
      <a class="btn" href="http://168.138.141.111:3000/validation?values=${params.values}" style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: #fff; text-decoration: none; border-radius: 5px;">Confirmar Cadastro</a>
    </p>
